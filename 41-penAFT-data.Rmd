...
* This is `r vignette_nm` vignette for  `r xlsxbs` data.
* Rmd file  `r paste(vignette_nm,".Rmd", sep = "")` was executed at `r Sys.time()`
...
Data frame `dtc` created from `r xlsxbs` dataset.


##  Preprocessing raw data

^ Original raw data are stored in .dbf format
